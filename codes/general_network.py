...
weight_type_vec = ['length', 'radius_base', 'rho', 'pressure', 'length_radius_base', 'length_pressure']
delta_weight_vec = [1e-3, 1, 1e-4, 1e-3, [1e-3, 1], [1e-3, 1e-3]] 
learning_rate_vec = [1e-6, 8e-7, 1e-4, 20, [1e-6, 8e-7], [1e-6, 20]]

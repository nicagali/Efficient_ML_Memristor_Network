...
training.train(G, training_type=training_type, training_steps=training_steps, weight_type='length', delta_weight = 1e-3, learning_rate=5e-5)
...
training.test_regression(G, step=29, weight_type='length')

fig, ax = plt.subplots(1, 3, figsize=(15,5))
plotting.plot_regression(ax[0], step=0)
plotting.plot_regression(ax[1], step=15)
plotting.plot_regression(ax[2], step=29)
fig.tight_layout()

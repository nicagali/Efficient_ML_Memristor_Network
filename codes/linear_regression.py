...
# training.train(G, training_type=training_type, training_steps=training_steps, weight_type='resistance', delta_weight = 1e-3, learning_rate=600)
...
plotting.plot_weights(ax, G, training_steps=training_steps, rule=f'{training_type}_length', show_xlabel=False)
ax.legend()
fig.tight_layout()

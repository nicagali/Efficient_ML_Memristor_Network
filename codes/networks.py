...
def random_graph(number_nodes=15, number_edges=40, save_data=False, res_change=False):
    ...
    voltage_input = [0, 5, 3] # node initialized here because different for differnent nw
